...
December 2020
python pom3_feature_selection_frequency.py --user <user> --password <password> --task_name <task_name> --dataset <dataset>
...
if __name__ == "__main__":
    ...
    display('Computing feature extraction for Xval...', logger, verbose)
    [Xval, yval] = dc.get_data_val()
    display('------- Sample before Feature Frequency Selection ---', logger, verbose)
    ...
    display('------- Sample after Feature Frequency Selection ---', logger, verbose)
    display(Xval_FE[0, :], logger, verbose)
    display('Shape after feature frequency selection: %s' %str(Xval_FE.shape), logger, verbose)

    display('---------------------------------------------------------------------', logger, verbose)
    display('---------------- Feature frequency selection completed --------------', logger, verbose)
    display('---------------------------------------------------------------------\n', logger, verbose)
