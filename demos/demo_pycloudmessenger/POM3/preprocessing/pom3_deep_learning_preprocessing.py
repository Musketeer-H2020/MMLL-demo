...
December 2020
python pom3_deep_learning_preprocessing.py --user <user> --password <password> --task_name <task_name> --dataset <dataset>
...
if __name__ == "__main__":
    ...
    display('Deep Learning image processing at workers', logger, verbose)
    ...
    display('------- Sample before Deep Learning Preprocessing ---', logger, verbose)
    ...
    display('------- Sample after Deep Learning Preprocessing ---', logger, verbose)
    display(Xval_DLP[0, :], logger, verbose)
    display('Shape after deep learning preprocessing: %s' %str(Xval_DLP.shape), logger, verbose)

    display('----------------------------------------------------------------------', logger, verbose)
    display('------------------- Deep learning preprocessing completed ------------', logger, verbose)
    display('----------------------------------------------------------------------\n', logger, verbose)
