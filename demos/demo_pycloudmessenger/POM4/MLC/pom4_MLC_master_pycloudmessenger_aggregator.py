...
Febr. 2021
python3 pom4_MLC_master_pycloudmessenger_aggregator.py --dataset M-iris --verbose 1
...
if __name__ == "__main__":
    ...
    if dataset_name in ['M-iris_norm', 'M-iris_norm_DV']:  # target >0.91
        Nmaxiter = 200 
        mu = 2.0
        momentum = 1.0
        conv_stop = 0.005
    ...
    if input_data_description is not None:
        ...
        aggregator_adversarial = SGD(0.5)
