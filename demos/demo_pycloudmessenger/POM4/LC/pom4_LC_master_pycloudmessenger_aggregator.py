...
if __name__ == "__main__":
    ...
    if dataset_name in ['pima', 'pima_DV']:
        NI = 8
    ...
    if input_data_description is not None:
        ...
        aggregator_adversarial = SGD(0.2)
    ...
    # OR, we can provide a validation set 
    ...
    if mn.model_is_trained:
        ...
        roc_auc_val, roc_auc_tst = eval_classification(pom, model_type, dataset_name, Xval_b, yval, Xtst_b, ytst, preds_val, preds_tst, logger, True, model_loaded, figures_folder)
