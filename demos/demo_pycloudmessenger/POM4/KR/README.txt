...
python3 pom4_KR_worker_pycloudmessenger.py --dataset sinc1D --verbose 1 --id 3 
python3 pom4_KR_worker_pycloudmessenger.py --dataset sinc1D --verbose 1 --id 4 
...
python3 pom4_KR_master_pycloudmessenger_aggregator.py --dataset sinc1D --verbose 1
