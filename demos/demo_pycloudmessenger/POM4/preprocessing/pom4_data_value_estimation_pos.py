...
if __name__ == "__main__":
    ...
    if input_data_description is not None:
        ...
        #model_parameters.update({'use_bias': True})  # fix internally depending on the model type
    ...
    dv, best_workers = mn.get_data_value_aposteriori(Xval, yval, baseline_auc=0.6)
