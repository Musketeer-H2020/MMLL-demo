...
Febr. 2021
python pom4_BSVM_worker_pycloudmessenger.py --id 0 --dataset pima --verbose 1
...
if __name__ == "__main__":
    ...
    display('Creating WorkerNode under POM5, communicating through pycloudmessenger', logger, True)
    #########################################
    ...
    wn.set_training_data(dataset_name, Xtr, ytr * 2 - 1)
