...
Jan. 2020
python pom4_Kmeans_worker_pycloudmessenger.py --id 0 --dataset synth2D --verbose 1
...
if __name__ == "__main__":
    ...
    display('Creating WorkerNode under POM4, communicating through pycloudmessenger', logger, True)
    #########################################
