...
if __name__ == "__main__":
    ...
    display('Preprocessing data at workers with logscale', logger, verbose)
    ...
    display('Preprocessing data at workers with outlier_clipping', logger, verbose)
    errors_outlier_clipping = mn.preprocess_data_at_workers(prep_outlier_clipping)
    Xval = prep_outlier_clipping.transform(Xval)

    display('-------------------------------------------------------------------------', logger, verbose)
    display('-------------------- Ad-hoc Preprocessing completed ---------------------', logger, verbose)
    display('-------------------------------------------------------------------------\n', logger, verbose)
