...
Example of use: python pom1_DSVM_master_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --normalization <normalization>
...
if __name__ == "__main__":
   ...
   # Retrieving and saving the final model
    ...
    output_filename = 'Master_DSVM_confusion_matrix_' + dataset_name + '.png'
    title = 'DSVM confusion matrix in test set master'
