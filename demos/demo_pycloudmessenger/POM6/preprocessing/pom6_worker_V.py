...
Jan. 2020
python pom6_LC_pm_worker_pycloudmessenger_V.py --id 0 --dataset pima --verbose 1
...
if __name__ == "__main__":
    ...
    [Xtr, ytr, input_data_description, target_data_description] = dc.get_data_train_Worker_V(int(worker_real_name[0]))
