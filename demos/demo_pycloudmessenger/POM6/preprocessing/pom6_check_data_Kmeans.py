...
if __name__ == "__main__":
    ...
    err, bad_workers = mn.check_data_at_workers(input_data_description, None)
    
    if err is None:
        display('=' * 50, logger, True)
        display('Data at workers is OK', logger, True)
        display('=' * 50, logger, True)
    else:
        display('=' * 50, logger, True)
        display('Data at workers has errors:\n %s' % err, logger, True)
        display('=' * 50, logger, True)
    ...
    display('\n---------------------------------------------------------------------', logger, True)
    display('------------------------- Check data completed  ----------------------', logger, True)
    display('----------------------------------------------------------------------\n', logger, True)
