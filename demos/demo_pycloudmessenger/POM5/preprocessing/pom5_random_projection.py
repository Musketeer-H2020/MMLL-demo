...
if __name__ == "__main__":
    ...
    display('Computing Random Projection for Xval...', logger, True)
    [Xval, yval] = dc.get_data_val()

    display('------- Sample before Random_projection ---\n', logger, True)
    display(Xval[0, :], logger, True)
    display(Xval.shape, logger, True)

    Xval_RP = random_projector.transform(Xval)
    
    display('------- Sample after Random_projection ---\n', logger, True)
    display(Xval_RP[0, :], logger, True)
    display(Xval_RP.shape, logger, True)

    display('\n---------------------------------------------------------------------', logger, True)
    display('---------- Random_projection completed  -------------------------------', logger, True)
    display('----------------------------------------------------------------------\n', logger, True)
