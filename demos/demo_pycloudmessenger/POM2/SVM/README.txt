...
Important notes:
    ...
    - It takes around 22 minutes to train the SVM on a machine with 8 cores and a modern processor due to the high processing times required for encrypting the weights of the model. In case you want to reduce the training time try a configuration with less centroids (NC) or less iterations (Nmaxiter).
-------------------------------------------
...
==================================================================
python pom2_SVM_master_pycloudmessenger.py --user <user> --password <password> --task_name <task_name>
python pom2_SVM_worker_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --id 0
python pom2_SVM_worker_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --id 1


==================================================================
 With std normalization
==================================================================
python pom2_SVM_master_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --normalization yes
python pom2_SVM_worker_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --id 0
python pom2_SVM_worker_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --id 1
