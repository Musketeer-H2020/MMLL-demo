...
December 2020
python pom2_principal_component_analysis.py --user <user> --password <password> --task_name <task_name> --dataset <dataset>
...
if __name__ == "__main__":
    ...
    display('------- Sample before PCA  -----------------', logger, verbose)
    ...
    display('------- Sample after PCA  -----------------', logger, verbose)
    display(Xval[0, :], logger, verbose)

    display('---------------------------------------------------------------------', logger, verbose)
    display('----------------------- PCA completed -------------------------------', logger, verbose)
    display('---------------------------------------------------------------------\n', logger, verbose)
