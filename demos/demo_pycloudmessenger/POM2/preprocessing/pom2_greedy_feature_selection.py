...
December 2020
python pom2_adhoc_preprocess.py --user <user> --password <password> --task_name <task_name> --dataset <dataset>
...
if __name__ == "__main__":
    ...
    display('------- Sample before Greedy Feature Selection  -----------------', logger, verbose)
    ...
    display('Preprocessing data at workers with feature_extract', logger, verbose)
    errors_feature_extract = mn.preprocess_data_at_workers(feature_extractor)

    display('------- Sample after Greedy Feature Selection  -----------------', logger, verbose)
    display(Xval[0, :], logger, verbose)

    display('---------------------------------------------------------------------', logger, verbose)
    display('------------------ Greedy feature selection completed ---------------', logger, verbose)
    display('---------------------------------------------------------------------\n', logger, verbose)
