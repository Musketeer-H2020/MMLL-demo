...
Parameters:
    ...
    - normalization: String indicating wether to apply standard normalization. Possible values are yes or no. By default normalization is not applied
...
Important notes:
    ...
    - The architecture of the Keras model to use is defined inside this folder (file keras_model_MLP_light_2.json). If you want to try a different architecture use the script model_definition_keras.py and define a new architecture using the sequential or functional API provided by Keras and then execute python model_definition_keras.py. The new filename with the architecture should be updated at the beginning of pom2_NN_master_pycloudmessenger.py in order for the changes to take place.
    - The architecture by default for this demo has around 8000 trainable parameters and it takes around 5 minutes to finish on a machine with 8 cores and a modern processor due to the high processing times required for encrypting the weights of the network. In case you want to reduce the training time try a network with less parameters or reduce the number of iterations.
-------------------------------------------
...
==================================================================
python pom2_NN_master_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --normalization yes
python pom2_NN_worker_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --id 0
python pom2_NN_worker_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --id 1
...
==================================================================
python pom2_NN_master_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --implementation gradient_averaging
python pom2_NN_worker_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --id 0
python pom2_NN_worker_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --id 1
...
==================================================================
python pom2_NN_master_pycloudmessenger.py --user <user> --password <password> --task_name <task_name>  --implementation gradient_averaging --normalization yes
python pom2_NN_worker_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --id 0
python pom2_NN_worker_pycloudmessenger.py --user <user> --password <password> --task_name <task_name> --id 1
